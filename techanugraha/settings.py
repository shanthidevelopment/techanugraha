"""
Django settings for techanugraha project.
...
SECRET_KEY = 'django-insecure-gc9*0b&(uxk64q@$&p-_&=a_qt&6+lf(y4urt+bgnid&h1#y7v'
...
ROOT_URLCONF = 'techanugraha.urls'
...
WSGI_APPLICATION = 'techanugraha.wsgi.application'
